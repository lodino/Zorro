...
set output '/Users/sufeng/git/ML_AUDB/symbolic/test3_gt/data.ps'
unset title
set tmargin -3
set bmargin -2
set rmargin 0
...
set yrange [*:*]
plot '/Users/sufeng/git/ML_AUDB/symbolic/test3_gt/data_1k.csv' using ($1-0.2):2:4:3:2 with candlesticks lt 1 lw 7 title '1k' whiskerbars,                 '/Users/sufeng/git/ML_AUDB/symbolic/test3_gt/data_GT.csv' using 1:2:4:3:2 with candlesticks lt 2 lw 7 title 'GT' whiskerbars,                 '/Users/sufeng/git/ML_AUDB/symbolic/test3_gt/data_FP.csv' using ($1+0.2):2:4:3:2 with candlesticks lt 3 lw 7 title 'FP' whiskerbars,